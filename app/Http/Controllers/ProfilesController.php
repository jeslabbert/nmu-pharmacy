...
class ProfilesController extends Controller
{
    ...
    public function profile_validator(array $data)
    {
        return Validator::make($data, [
            ...
            'sapc_active'       => '',
            'pssa_active'       => '',
            'primary_cell'      => 'numeric|phone_number|min:10|max:11',
            'secondary_cell'    => 'numeric|phone_number|min:10|max:11',
            'sa_id'             => 'numeric|size:13',
        ]);
    }
...
//            'practiceSites' => $practiceSites,
    ...
    public function update($username, Request $request)
    {
        ...
        if(isset($input['sapc_active']))
        {
            $input['sapc_active'] = ($input['sapc_active'] ==='on' ? true : false );
        }
...
//dd($qualification);
    ...
    public function updateUserAccount(Request $request, $id)
    {
        ...
        $user->sa_id        = $request->input('sa_id');
        $user->sex          = $request->input('sex');
        $user->primary_cell    = $request->input('primary_cell');
        $user->secondary_cell    = $request->input('secondary_cell');
...
//        $qualifications['graduated'] = Carbon::now(); // for now
    ...
    public function delete_qualification(Request $request)
    {
        ...
        $user = auth()->user();
        $id_to_be_deleted = $request->input('id_qualification');
